...
class Artista:
    def __init__(self, id, nome, estilo, data_nascimento, contacto="", discografia=""):
        self.id = id
        self.nome = nome
        self.estilo = estilo
...
def adicionar_artista(artistas, id_counter):
    ...
    novo_artista = Artista(id_counter, nome, estilo, data_nascimento)
...
def listar_artistas(artistas):
    ...
    for artista in artistas:
        print(f"ID: {artista.id} | Nome: {artista.nome} | Estilo: {artista.estilo} | Nascimento: {artista.data_nascimento}")
